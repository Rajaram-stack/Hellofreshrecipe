...
def main():
  ...
  programme
  """
  input_file_path="dbfs:/FileStore/shared_uploads/adminpen.rs@osram-os.com/recipes_002.json"
  output_file_path="dbfs:/FileStore/shared_uploads/adminpen.rs@osram-os.com/recipeoutput/"
